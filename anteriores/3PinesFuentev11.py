...
def pwm_thread():
    ...
    while running:
        ...
        GPIO.output(pwm_pins[1], GPIO.LOW)  # Apagar pin 23 mientras pin 18 está encendido
        ...
        GPIO.output(pwm_pins[0], GPIO.LOW)  # Apagar pin 18 mientras pin 23 está encendido
        time.sleep(off_time_18)
